...
use PwdTask\Exceptions\InvalidArgumentException;
...
if (!$isRouteFound) {
    throw new \PwdTask\Exceptions\NotFoundException();
}
...
catch (\PwdTask\Exceptions\DbException $e) {
    $view = new \PwdTask\View\View(__DIR__ . '/../templates/errors');
    $view->renderHtml('500.php', ['error' => $e->getMessage()], 500);
}
catch (\PwdTask\Exceptions\NotFoundException $e) {
    $view = new \PwdTask\View\View(__DIR__ . '/../templates/errors');
